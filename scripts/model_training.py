...
def run(args):
    ...
    X_train = np.load(os.path.join(data_dir, 'prep\\X_train.npy'))
    y_train = np.load(os.path.join(data_dir, 'prep\\y_train.npy'))
    X_test = np.load(os.path.join(data_dir, 'prep\\X_test.npy'))
    y_test = np.load(os.path.join(data_dir, 'prep\\y_test.npy'))
